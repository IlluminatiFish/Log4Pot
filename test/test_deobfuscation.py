...
def test_obfusc_date_single_quote():
    assert deobfuscate("${${upper:j}${lower:n}${lower:d}${upper:i}${date:':'}${lower:l}${lower:d}${date:'a'}${test:by:d2lab:-p}${lower::}${date:'/'}${date:'/'}127.0.0.1/test}") == "${jndi:ldap://127.0.0.1/test}"
